...
def get_notes():
    ...
    try:
        ...
        # استخراج التوكن باستخدام html.parser المدمج لتفادي كراش lxml
        ...
        if response_notes.status_code == 200:
            ...
            if table:
                ...
                return jsonify({
                    'status': 'error',
                    'message': '❌ لم يتم العثور على جدول النقاط أو تم حظر السيرفر من طرف متمدرس'
                }), 404
        ...
        return jsonify({
            'status': 'error',
            'message': '❌ انتهت مهلة الاتصال - خادم مسار بطيء جداً أو تم حظر السيرفر'
        }), 504
